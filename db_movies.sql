...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2017 at 03:30 AM
...
(168, 'Andy', 'Samberg'),
(169, 'James', 'Caan'),
(170, 'Neil Patrick', 'Harris'),
(171, 'John', 'Leguizamo'),
(172, 'Ray', 'Romano'),
(173, 'Denis', 'Leary'),
(174, 'Queen', 'Latifah'),
(175, 'Carlos', 'Saldanha'),
(176, 'Jennifer', 'Aniston'),
(177, 'Jamie', 'Foxx'),
(178, 'Nicolas', 'Cage'),
(179, 'Chloe Grace', 'Moretz'),
(180, 'Alan', 'Ford'),
(181, 'Todd', 'Phillips'),
(182, 'Woody', 'Allen'),
(183, 'Penelope', 'Cruz'),
...
CREATE TABLE tbl_comment (
  ...
  comment_fname varchar(25) NOT NULL,
  comment_lname varchar(25) NOT NULL
...
INSERT INTO tbl_comment (comment_id, comment_content, comment_movie, comment_fname, comment_lname) VALUES
(1, 'This movie is great!', 1, 'Jean-Philippe', 'Legacy'),
(2, 'It was meh', 2, 'Jean-Philippe', 'Legacy'),
(3, 'I am a teacher, I do not watch movies', 1, 'Justin', 'Brunner');
...
--
-- Table structure for table tbl_l_movcast
--

CREATE TABLE tbl_l_movcast (
  movcast_id smallint(4) NOT NULL,
  movies_id tinyint(4) NOT NULL,
  cast_id smallint(4) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table tbl_l_movcast
--

INSERT INTO tbl_l_movcast (movcast_id, movies_id, cast_id) VALUES
(1, 1, 1),
(12, 3, 18),
(3, 1, 2),
(4, 1, 3),
...
CREATE TABLE tbl_user (
  ...
  user_attempts tinyint(1) NOT NULL,
  user_lockout_date datetime NOT NULL,
  user_email varchar(50) NOT NULL,
  user_edited varchar(3) NOT NULL DEFAULT 'no',
  user_create_date datetime NOT NULL DEFAULT '1000-01-01 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO tbl_user (user_id, user_fname, user_lname, user_name, user_pass, user_level, user_ip, user_login_date, user_attempts, user_lockout_date, user_email, user_edited, user_create_date) VALUES
(1, 'jean-philippe', 'legacy', 'jplegacy', 'hahaha', '1', '1', '2017-03-09 15:27:40', 0, '2017-02-13 19:46:35', 'woot', 'mer', '1000-01-01 00:00:00'),
(2, 'justin', 'brunner', 'jbrunner', 'Yr5v+C', '1', '0', '2017-01-25 23:43:17', 0, '2017-01-25 23:43:17', '', 'yes', '1000-01-01 00:00:00'),
(31, 'jacob', 'millar', 'jmillar', 'lol', '2', '31', '2017-03-08 23:54:23', 0, '1000-01-01 00:00:00', 'dsaf', 'yes', '2017-03-08 23:53:34');
...
--
-- Indexes for table tbl_l_movcast
--
ALTER TABLE tbl_l_movcast
  ADD PRIMARY KEY (movcast_id);
...
--
-- AUTO_INCREMENT for table tbl_l_movcast
--
ALTER TABLE tbl_l_movcast
  MODIFY movcast_id smallint(4) NOT NULL AUTO_INCREMENT;
--
